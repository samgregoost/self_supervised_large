...
tf.flags.DEFINE_string("logs_dir", "/scratch1/ram095/nips20/logs_mcz3l/", "path to logs directory")
...
#    z_loss = zloss_ + 0.1* zloss_lip# + zloss_lip_inv
    ...
    lip_loss_norm = 0.6*tf.reduce_mean(tf.reduce_sum(tf.contrib.layers.flatten(tf.abs((logits - logits_lip))),1))
