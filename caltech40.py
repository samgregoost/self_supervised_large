...
tf.flags.DEFINE_string("logs_dir", "/scratch1/ram095/nips20/logs_caltech40/", "path to logs directory")
tf.flags.DEFINE_string("data_dir", "/scratch1/ram095/nips20/datasets/caltech/", "path to dataset")
