...
tf.flags.DEFINE_string("logs_dir", "/scratch1/ram095/nips20/log_paris/", "path to logs directory")
...
#                print(z_)
        ...
        valid_images_masked = (1-sess.run(mask))*valid_images + 255*sess.run(mask)
