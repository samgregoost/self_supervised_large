...
tf.flags.DEFINE_string("logs_dir", "/scratch1/ram095/nips20/logs_contextrz/", "path to logs directory")
...
def inference(images, keep_prob,z,is_train):
    ...
    with tf.variable_scope("inference"):
        ...
        debn = tf.nn.relu(batchnorm(deconv, is_train, name=("debn" + str(decoderLayerNum)))) + z
        print("#################################")
        print(debn)
