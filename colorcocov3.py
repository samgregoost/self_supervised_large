...
tf.flags.DEFINE_string("logs_dir", "/scratch1/ram095/nips20/logs_colorcocov3/", "path to logs directory")
...
def inference(images, keep_prob,z,e,is_train):
    ...
    with tf.variable_scope("decoder", reuse = tf.AUTO_REUSE):
        ...
        a_channel = tf.nn.tanh(new_deconv_layer( debn, [4,4,1,previousDepth], [FLAGS.batch_size,64,64,1], stride=2, name="recon"))
        
        f_map = new_deconv_layer( debn, [4,4,1,previousDepth], [FLAGS.batch_size,64,64,1], stride=2, name="f_map")
