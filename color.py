...
tf.flags.DEFINE_string("logs_dir", "/scratch1/ram095/nips20/logs_color/", "path to logs directory")
tf.flags.DEFINE_string("data_dir", "/scratch1/ram095/nips20/datasets/Lin", "path to dataset")
...
#        pred = pred + 1./2.0*255
       ...
       # print(np.max(pred))
        ...
        print(valid_annotations_.shape)
        print(pred.shape)
