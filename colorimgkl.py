...
tf.flags.DEFINE_string("logs_dir", "/flush5/ram095/nips20/logs_colorimgkl/", "path to logs directory")
tf.flags.DEFINE_string("data_dir", "/flush5/ram095/nips20/datasets/imagenet3", "path to dataset")
