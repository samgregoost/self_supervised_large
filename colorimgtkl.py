...
import datetime
import BatchDatsetReaderTest as dataset
...
tf.flags.DEFINE_string("logs_dir", "/flush5/ram095/nips20/logs_colorimgtkl/", "path to logs directory")
tf.flags.DEFINE_string("data_dir", "/flush5/ram095/nips20/datasets/imagenet", "path to dataset")
...
#        pred = pred + 1./2.0*255
        ...
        valid_annotations_ = valid_annotations * 100.0
