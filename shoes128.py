...
tf.flags.DEFINE_string("logs_dir", "/flush5/ram095/nips20/logs_shoeslarge/", "path to logs directory")
...
def main(argv=None):
    ...
    image_ = tf.image.random_crop(image_, size = (FLAGS.batch_size*2, 128,128,3))
