...
tf.flags.DEFINE_string("logs_dir", "/scratch1/ram095/nips20/logs_colorstlmean/", "path to logs directory")
...
def inference(images, keep_prob,z,e,is_train):
    ...
    with tf.variable_scope("decoder", reuse = tf.AUTO_REUSE):
      ...
      #  print(debn)
        ...
        recon = tf.nn.tanh(new_deconv_layer( debn, [4,4,2,previousDepth], [FLAGS.batch_size,64,64,2], stride=2, name="recon"))
...
#                print(z_) 
               ...
               # print(v.shape)
               # print(z_.shape)
            feed_dict = {image: train_images, annotation: train_annotations, keep_probability:0.85,e:error_dec, istrain:True }
