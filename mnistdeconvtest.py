...
import datetime
import BatchDatsetReaderMnistTest as dataset
from six.moves import xrange
import math

FLAGS = tf.flags.FLAGS
tf.flags.DEFINE_integer("batch_size", "20", "batch size for training")
tf.flags.DEFINE_string("logs_dir", "/scratch1/ram095/nips20/logs_test/", "path to logs directory")
  ...
  #  loss = tf.reduce_mean(tf.squared_difference(logits ,annotation ))
    ...
    if FLAGS.mode == "train":
        for itr in xrange(MAX_ITERATION):
            ...
            train_images[train_images < 127] = 0.0
            train_annotations[train_annotations < 127] = 0.0
...
#                print(z_) 
            ...
            if itr % 500 == 0:
                ...
                valid_annotations[valid_annotations < 127] = 0.0
                valid_images[valid_images < 127] = 0.0
        ...
        valid_images[valid_images < 127] = 0.0
        valid_annotations[valid_annotations >= 127] = 255
        valid_images[valid_images >= 127] = 1.0
