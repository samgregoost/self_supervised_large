...
tf.flags.DEFINE_string("logs_dir", "/scratch1/ram095/nips20/logs_contextrzconcatnorm/", "path to logs directory")
...
def inference(images, keep_prob,z,is_train):
    ...
    with tf.variable_scope("inference"):
        ...
        debn = tf.concat([tf.nn.relu(batchnorm(deconv, is_train, name=("debn" + str(decoderLayerNum)))),tf.tile(z_,[1,4,4,1])],axis = 3)
        print("#################################")
        print(debn)
